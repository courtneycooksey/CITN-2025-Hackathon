...
namespace Hackathon.Server.Service {
  public class CensusPovertyByEmploymentStatusService {
    ...
    public IQueryable<CensusPovertyByEmploymentStatus> GetAll(){
      return _context.CensusPovertyByEmploymentStatuses;
    }
    
    public CensusPovertyByEmploymentStatus Get(int id){
